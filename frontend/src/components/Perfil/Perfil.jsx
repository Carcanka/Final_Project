    ...
    return (
        <>
            <div className="user-perfil-container">
                ...
                <div className="perfil-footer-container">
                    <Link to="/home" className="perfil-footer-container-item">
                        <img src={HomeLogo} alt="" />
                        <span>Inicio</span>
                    </Link>
                    <Link to="/buscador" className="perfil-footer-container-item">
                        <img src={Search} alt="" />
                        <span>Buscador</span>
                    </Link>
                    <Link to="/profile" className="perfil-footer-container-item">
                        <img src={User} alt="" />
                        <span>Perfil</span>
                    </Link>
                    <Link to="/friends" className="perfil-footer-container-item">
                        <img src={Friends} alt="" />
                        <span>Amigos</span>
                    </Link>
                </div>
